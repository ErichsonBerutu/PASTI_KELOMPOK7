...
import (
	...
	"github.com/ErichsonBerutu/regional/pkg/models"
	"github.com/ErichsonBerutu/regional/pkg/utils"
...
func CreateRegional(w http.ResponseWriter, r *http.Request) {
	...
	// Mengonversi hasil pembuatan regional baru menjadi format JSON.
